...
export class ChatResponseStreamImpl implements FinalizableChatResponseStream {
	...
	public static spy(stream: ChatResponseStream, callback: (part: ExtendedChatResponsePart) => void, finalize?: () => void, usageCallback?: (usage: ChatResultUsage) => void): ChatResponseStreamImpl {
